...
import configFileParser2.data.GameConfig;
import configFileParser2.data.UserInterfaceConfig;
...
public class Main {
    ...
    private static final Path GAME_CONFIG_PATH = Path.of("resources/configparser2/game-properties.cfg");
    private static final Path UI_CONFIG_PATH = Path.of("resources/configparser2/user-interface.cfg");
