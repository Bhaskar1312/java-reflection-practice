...
public class SqlQueryBuilder {
    ...
    public String addWhereClause(@Annotations.DependOn("SelectBuilder") String query,
    ...
    public String addLimit(@Annotations.DependOn("SelectBuilder") String query, @Annotations.Input("limit") Integer limit) {
