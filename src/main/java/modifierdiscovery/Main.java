package modifierdiscovery;

import modifierdiscovery.auction.Auction;
import modifierdiscovery.auction.Bid;
...
//        runAction();
        ...
        printClassModifiers(Class.forName("modifierdiscovery.auction.Bid$Builder$BidImpl"));
